...
int main( int argc, char *argv[] )
{
    ...
    std::vector<data_type> input_merge_sort_sort_data(input_data);
    test_sort("MERGE", merge_sort, input_merge_sort_sort_data, input_standart_sort_data);
